...
source("https://github.com/bradytwest/IndicesOfNISB/raw/master/smub_functions_V3.R");
...
# NOTE: fit1$mean_X_pop can be replaced with the known mean for X from the target population.
