...
# MUBP analyses for females (unique sampling fraction); NO CROSS-VALIDATION

mle2stepMUBP(x_0=xlp, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=0)
mle2stepMUBP(x_0=xlp, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=0.5)
mle2stepMUBP(x_0=xlp, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=1)

# MUBP analyses for females (unique sampling fraction); WITH CROSS-VALIDATION
...
mle2stepMUBP(x_0=xlp.cv, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=0)
mle2stepMUBP(x_0=xlp.cv, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=0.5)
mle2stepMUBP(x_0=xlp.cv, y_0=y, xmean_1=xmean.ns, xvar_1=xvar.ns, sfrac=0.817, phi=1) 
...
###############################################################################
# Draws OF MUBP from posterior for different values of phi, and for drawing phi.
...
# Return MUBP draws and credible intervals
PD
